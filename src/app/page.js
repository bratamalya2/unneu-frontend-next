...
export default function Home() {
  ...
  return (
    <main className="relative lg:top-[120px]">
      ...
      <article className="relative z-0 my-[25px] xl:my-[35px] md:my-[56px] lg:max-w-[85%] xl:max-w-[80%] 2xl:max-w-[75%] mx-auto flex flex-col items-center">
        ...
        <p className="my-[32px] sm:text-[18px] lg:text-xl text-center px-5 sm:px-0" id="landing-page-seller-region">
