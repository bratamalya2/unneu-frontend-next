...
export default function Home() {
  return (
    <main>
      ...
      <article className="my-[86px] max-w-[40%] mx-auto flex flex-col items-center">
        ...
        <button className="max-w-[168px] py-[16px] px-[32px] rounded-[20px] bg-[#FBC246] text-[18px] font-medium">Explore</button>
      </article>
      <LandingPageSeller />
      <LandingPageBuyer />
