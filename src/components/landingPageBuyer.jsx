...
export default function LandingPageBuyer() {
    return <>
        <section className="relative hidden lg:flex lg:top-[1200px] xl:top-[1400px] 2xl:top-[1700px] w-full items-center justify-center gap-x-8 items-center">
        ...
        <section className="relative flex flex-col lg:hidden top-[480px] sm:top-[640px] md:top-[700px] w-full items-center">
