...
export default function LandingPageBuyer() {
    return <>
        <section className="relative hidden xl:flex xl:top-[1100px] 2xl:top-[1300px] w-full items-center justify-center gap-x-6 items-center">
        ...
        <section className="relative flex flex-col xl:hidden top-[380px] sm:top-[640px] md:top-[700px] lg:top-[900px] xl:top-[750px] w-full items-center">
            <aside className="w-[85%] sm:w-[60%] lg:w-[50%] px-3 flex flex-col items-center z-10">
                <p className="font-bold text-2xl lg:text-4xl">
                    Embrace hands-me-down : <span className="text-[#FE9135]">Going back to roots.</span>
                </p>
                <p className="my-[32px] lg:text-xl">
                    Swap your sarees among your community and
                    share the warmth of sisterhood that each saree carries
                    through its memory.
                </p>
            ...
            <Image src={LandingPageSellerBackground} alt="circles" className="w-[113px] sm:w-[366px] h-[118px] sm:h-[373px] absolute z-[-10] right-0 bottom-0 sm:bottom-[-100px] md:bottom-[-70px]" />
        </section>
    </>
}