    ...
    return <>
                        ...
                        <>
                            ...
                            <div className="relative">
                                <input
                                    ...
                                    className={`${isEmailOtpVerified && "text-green-500 line-through"} mt-[18px] mb-[5px] w-full py-[12px] pl-5 pr-[100px] rounded-[12px] border-[0.6px] border-[#00000080] bg-[#F9F9F9]`}
                                    style={{
                                        boxShadow: " 0px 11px 53.8px 4px rgba(81, 69, 55, 0.05)"
                                    }}
                                />
                        ...
                        <>
                            ...
                            <div className="relative">
                                <input
                                    ...
                                    placeholder="Enter OTP"
                                    className={`${isPhoneOtpVerified && "text-green-500 line-through"} mt-[18px] mb-[5px] w-full py-[12px] pl-5 pr-[100px] rounded-[12px] border-[0.6px] border-[#00000080] bg-[#F9F9F9]`}
                                    style={{
                                        boxShadow: " 0px 11px 53.8px 4px rgba(81, 69, 55, 0.05)"
                                    }}
                                />
        ...
        <section className={`relative mt-[50px] md:hidden pr-[5%] ${panImagePreview && "mb-[200px]"}`}>
            ...
            <aside className="absolute w-[90vw] h-fit z-10 top-[450px] left-[5vw] rounded-tl-[24px] rounded-tr-[24px] bg-white py-[36px] px-[16px]" style={{
                        ...
                        <>
                            ...
                            <div className="relative">
                                <input
                                    ...
                                    disabled={isEmailOtpVerified}
                                    placeholder="Enter OTP"
                                    className={`${isEmailOtpVerified && "text-green-500 line-through"} text-sm rounded-[12px] pl-[12px] py-[16px] pr-[100px] w-full bg-[#F9F9F9] border-[0.6px] border-[#00000080]`}
                                    style={{
                                        boxShadow: "0px 11px 53.8px 4px rgba(81, 69, 55, 0.05)"
                                    }}
                                />
                        ...
                        <>
                            ...
                            <div className="relative">
                                <input
                                    ...
                                    disabled={isPhoneOtpVerified}
                                    placeholder="Enter OTP"
                                    className={`${isPhoneOtpVerified && "text-green-500 line-through"} text-sm rounded-[12px] pl-[12px] py-[16px] pr-[100px] w-full bg-[#F9F9F9] border-[0.6px] border-[#00000080]`}
                                    style={{
                                        boxShadow: " 0px 11px 53.8px 4px rgba(81, 69, 55, 0.05)"
                                    }}
                                />
                ...
                />
                <button className="mt-[32px] rounded-[12px] text-white font-semibold bg-[#FE9135] w-full h-[48px]" onClick={handleFormSubmit}>Save and Continue</button>
            </aside>
        </section >
    </>
}