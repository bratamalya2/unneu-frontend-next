...
export default function LandingPageHowItWorks() {
    return <section className="relative top-[1860px] bg-[#E05F1D] text-white w-full h-[850px] pl-[10%]">
        ...
        <section className="absolute flex flex-wrap justify-center items-center gap-x-[10%] w-[80%] mx-auto mt-[210px] gap-y-[114px]">
            <div className="flex flex-nowrap lg:w-[42%] xl:w-[35%] justify-between items-center">
