...
export default function LandingPageNewsletter() {
    return <section className="relative top-[1800px] lg:h-[450px] xl:h-[450px] 2xl:h-[504px]">
        ...
        <p className="absolute z-20 lg:max-w-[52%] xl:max-w-[40%] 2xl:max-w-[32%] left-[10%] lg:top-[64px] xl:top-[64px] 2xl:top-[84px] text-[#E3E3E3] lg:text-[40px] xl:text-[48px] font-bold">
        ...
        <Image src={ForwardArrow} alt="right arrow" className="absolute z-30 xl:left-[27%] lg:left-[30%] lg:top-[344px] xl:top-[332px] 2xl:top-[392px] w-[34px] h-[34px] hover:cursor-pointer" />
    </section>
}