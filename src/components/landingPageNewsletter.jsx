...
export default function LandingPageNewsletter() {
    return <section className="relative 2xl:top-[1800px] xl:top-[1550px] lg:h-[450px] xl:h-[450px] 2xl:h-[504px]">
        <Image src={Background} alt="bg" className="absolute z-10 h-full w-full" />
        <Image src={Foreground} alt="fg" className="absolute z-10 h-full w-[50%] right-0" />
