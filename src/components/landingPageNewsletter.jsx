...
export default function LandingPageNewsletter() {
    return <>
        <section className="relative hidden lg:block lg:top-[1050px] xl:top-[1380px] 2xl:top-[1800px] lg:h-[550px] xl:h-[450px] 2xl:h-[504px]">
        ...
        <section className="relative lg:hidden top-[450px] sm:top-[750px] md:top-[800px] w-full h-[630px]">
