...
export default function LandingPageNewsletter() {
    return <>
        <section className="relative hidden md:block top-[700px] 2xl:top-[1800px] xl:top-[1550px] lg:h-[450px] xl:h-[450px] 2xl:h-[504px]">
        ...
        <section className="relative md:hidden top-[660px] sm:top-[900px] w-full h-[714px]">
            <Image src={Background2} alt="bg" className="absolute z-10 h-full w-full" />
            <p className="absolute z-20 max-w-[80%] sm:max-w-[45%] left-[10%] top-[74px] text-[#E3E3E3] text-2xl font-bold">
                Join the sustainability revolution: <span className="text-[#FE9135]">one saree at a time.</span>
            </p>
            <p className="absolute z-20 mt-[32px] max-w-[60%] sm:max-w-[45%] left-[10%] top-[162px] text-white">
                Join our newsletter for more Updates
            </p>
            ...
            <Image src={Foreground} alt="fg" className="absolute z-10 w-full max-h-[504px] sm:max-h-[480px] right-0 bottom-0" />
        </section>
    </>
}