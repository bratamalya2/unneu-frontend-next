...
export default function LandingPageNewsletter() {
    return <>
        ...
        <section className="relative sm:hidden top-[500px] w-full h-[714px]">
            ...
            <input type="email" placeholder="Enter your e-mail" className="absolute z-20 mt-[32px] left-[10%] top-[240px] h-[38px] w-[230px] rounded-[20px] px-3 font-medium" />
            <Image src={ForwardArrow} alt="right arrow" className="absolute z-30 left-[232px] top-[274px] w-[34px] h-[34px] hover:cursor-pointer" />
            <Image src={Foreground} alt="fg" className="absolute z-10 h-[300px] w-full right-0 bottom-0" />
        </section>
    </>
}