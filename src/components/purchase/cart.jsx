...
export default function Cart() {
    ...
    return <section className="w-full px-[5%]">
        <p className={`${lbFont.className} text-2xl lg:text-4xl font-semibold lg:font-bold`}>Shopping Cart</p>
        ...
        <section className="mt-[32px] lg:mt-[42px] w-ful flex flex-col lg:flex-row justify-between">
            ...
            <aside className="relative mt-[44px] w-full lg:w-[30%] bg-[#F8F8F8] rounded-t-[32px] h-fit px-[25px] py-[12px] overflow-hidden z-[-20]" style={{
                ...
                <Image src={LeftLeaf} alt="leaf" className="absolute h-[300px] w-[85px] bottom-[-80px] left-[-65px] z-[-10]" />
                <Image src={RightLeaf} alt="leaf" className="absolute h-[300px] w-[85px] bottom-[-80px] right-[-65px] z-[-10]" />
                <p className={`${lbFont.className} font-semibold text-lg lg:text-3xl`}>Order summary</p>
                ...
                <div className="w-full mt-[41px] flex flex-row flex-nowrap items-center justify-between">
                    <p className="font-semibold text-[15px] lg:text-base">Subtotal :</p>
                ...
                <div className="w-full mt-[15px] flex flex-row flex-nowrap items-center justify-between">
                    <p className="font-semibold text-[15px] lg:text-base">Shipping :</p>
                    <p className="lg:text-[18px] font-medium">FREE</p>
                </div>
                <div className="w-full mt-[15px] flex flex-row flex-nowrap items-center justify-between">
                    <p className="font-semibold text-[15px] lg:text-base">Estimated tax :</p>
