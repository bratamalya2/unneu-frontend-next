...
export default function Nav({ stage }) 
{
    ...
    return <section className="my-[30px] lg:my-[60px] mx-auto w-[90%] flex flex-row flex-nowrap items-center">
        <button  onClick={() => {
              // Force a full page reload to the address page
              window.location.href = '/purchase?slug=cart';
            }}
                            className={`${stage === 1 ? "bg-[#FDDF9F] text-black" : "bg-[#F2F2F2] text-[#8C8A8A]"} rounded-[12px] w-[78px] h-[65px] flex flex-col flex-nowrap justify-center items-center gap-y-[4px]`}>
        ...
        <Image src={HorizontalLine} alt="line" className="hidden lg:block h-[1px] w-[45%]" />
