...
export default function MobileFilters({ appliedFilters, addFilter, removeFilter, removeAllFilters, showMobileFilters, handleCloseMobileFilters }) {
    ...
    return <section className={`${showMobileFilters ? "w-[70%] h-fit mt-[30px] pb-[50px]" : "w-0 h-0"} transition-[width] duration-500 ease-in-out sticky shadow-2xl rounded-t-[10px] rounded-br-[10px] bg-white top-[20vh] z-50 overflow-y-auto z-[500]`}>
