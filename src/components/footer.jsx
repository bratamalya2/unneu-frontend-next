    ...
    return <>
        <footer className={`w-full relative list-none text-[#282828] text-[18px] font-medium hidden lg:flex
                ...
                pathname === "/seller/home" ? "lg:top-[2500px] xl:top-[2600px] 2xl:top-[2700px] h-[950px] xl:h-[600px] gap-x-14 pt-[100px] px-[5%]" :
                    (pathname === "/seller/register/1" || pathname === "/seller/register/2" || pathname === "/seller/register/3" || pathname === "/seller/uploadItem" || pathname === "/seller/editItem" || pathname === "/aboutUs" || pathname === "/buyer/home" || pathname === "/item") ? "h-[970px] xl:h-[600px] gap-x-14 pt-[100px] px-[7%]" :
        ...
        ${(pathname === "/seller/register/2" || pathname === "/seller/register/3" || pathname === "/seller" || pathname === "/seller/uploadItem" || pathname === "/seller/editItem" || pathname === "/aboutUs" || pathname === "/buyer/home" || pathname === "/item") && "min-[300px]:top-[100px] sm:top-[760px] min-[730px]:top-[840px] md:top-[820px] min-[780px]:top-[880px] min-[848px]:top-[910px] min-[880px]:top-[950px] min-[910px]:top-[990px] min-[950px]:top-[1040px] min-[1000px]:top-[1100px] lg:top-0 h-[1100px] sm:h-[950px] px-[5%] py-[41px]"}
