...
export default function Footer() {
    return <>
        <footer className="w-full h-[743px] xl:h-[550px] relative top-[900px] 2xl:top-[1800px] xl:top-[1550px] hidden sm:flex gap-x-14 pt-[100px] list-none px-[9%] text-[#282828] text-[18px] font-medium" style={{
        ...
        <footer className="sm:hidden flex flex-col flex-nowrap top-[500px] h-[1016px] px-[5%] py-[41px] list-none relative" style={{
            background: "linear-gradient(0deg, #FFC595 0%, #FFEDDE 100%)"
        }}>
            <li className="w-full">
