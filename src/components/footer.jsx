...
export default function Footer() {
    ...
    return <>
        ...
        ${pathname === "/seller/register/1" && "min-[300px]:top-[1460px] min-[570px]:top-[680px] sm:top-[760px] min-[730px]:top-[840px] md:top-[820px] min-[780px]:top-[880px] min-[848px]:top-[910px] min-[880px]:top-[950px] min-[910px]:top-[990px] min-[950px]:top-[1040px] min-[1000px]:top-[1100px] h-[1100px] sm:h-[950px] px-[5%] py-[41px]"} 
        ${(pathname === "/seller/register/2" || pathname === "/seller/register/3" || pathname === "/seller" || pathname === "/seller/uploadItem") && "min-[300px]:top-[70px] sm:top-[760px] min-[730px]:top-[840px] md:top-[820px] min-[780px]:top-[880px] min-[848px]:top-[910px] min-[880px]:top-[950px] min-[910px]:top-[990px] min-[950px]:top-[1040px] min-[1000px]:top-[1100px] h-[1100px] sm:h-[950px] px-[5%] py-[41px]"}
