...
export default function SellerHomeStepsToStartSelling() {
    ...
    return <section className="absolute px-[10%] lg:top-[580px] xl:top-[650px] 2xl:top-[750px] mt-[85px] w-full">
        ...
        <section className="flex flex-row flex-nowrap mt-[48px] w-full">
            ...
            <aside className="w-[50%] xl:w-[54%] relative">
                <Image src={Register} alt="register" className="w-[86px] h-[86px] absolute top-0 left-[20%]" />
                <Image src={DottedLine} alt="line" className="w-[1px] h-[57px] absolute top-[85px] seller-home-dotted-line" />
                <Image src={List} alt="list" className="w-[86px] h-[86px] absolute top-[140px] left-[20%]" />
                <Image src={DottedLine} alt="line" className="w-[1px] h-[57px] absolute top-[225px] seller-home-dotted-line" />
                <Image src={Manage} alt="list" className="w-[86px] h-[86px] absolute top-[280px] left-[20%]" />
                <Image src={DottedLine} alt="line" className="w-[1px] h-[57px] absolute top-[365px] seller-home-dotted-line" />
                <Image src={Shipping} alt="shipping" className="w-[86px] h-[86px] absolute top-[420px] left-[20%]" />
                <Image src={DottedLine} alt="line" className="w-[1px] h-[57px] absolute top-[505px] seller-home-dotted-line" />
                <Image src={Payments} alt="payments" className="w-[86px] h-[86px] absolute top-[562px] left-[20%]" />
                <div className="absolute top-[10px] lg:left-[43%] min-[1100px]:left-[42%] min-[1200px]:left-[41%] xl:left-[40%] min-[1400px]:left-[39%] min-[1450px]:left-[38%] min-[1500px]:left-[37%] 2xl:left-[35%]">
                ...
                <div className="absolute top-[150px] lg:left-[43%] min-[1100px]:left-[42%] min-[1200px]:left-[41%] xl:left-[40%] min-[1400px]:left-[39%] min-[1450px]:left-[38%] min-[1500px]:left-[37%] 2xl:left-[35%]">
                ...
                <div className="absolute top-[290px] lg:left-[43%] min-[1100px]:left-[42%] min-[1200px]:left-[41%] xl:left-[40%] min-[1400px]:left-[39%] min-[1450px]:left-[38%] min-[1500px]:left-[37%] 2xl:left-[35%]">
                ...
                <div className="absolute top-[430px] lg:left-[43%] min-[1100px]:left-[42%] min-[1200px]:left-[41%] xl:left-[40%] min-[1400px]:left-[39%] min-[1450px]:left-[38%] min-[1500px]:left-[37%] 2xl:left-[35%]">
                    <p className="text-xl font-medium">Free shipping</p>
                    <p className="text-[14px] max-w-[78%]">Ship promptly and securely to buyers.</p>
                </div>
                <div className="absolute top-[575px] lg:left-[43%] min-[1100px]:left-[42%] min-[1200px]:left-[41%] xl:left-[40%] min-[1400px]:left-[39%] min-[1450px]:left-[38%] min-[1500px]:left-[37%] 2xl:left-[35%]">
