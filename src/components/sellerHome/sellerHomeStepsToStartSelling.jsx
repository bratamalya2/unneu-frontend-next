...
export default function SellerHomeStepsToStartSelling() {
    ...
    return <section className="absolute px-[5%] lg:px-[10%] top-[700px] lg:top-[520px] xl:top-[570px] 2xl:top-[750px] lg:mt-[85px] w-full">
        <p className="text-2xl lg:text-4xl font-medium">Steps to <span className="text-[#D57A2D] font-semibold">Start Selling</span></p>
        <section className="absolute lg:static flex flex-col lg:flex-row flex-nowrap mt-[20px] lg:mt-[48px] w-[90%] lg:w-full left-[5%] lg:left-0">
            <aside className="relative w-full lg:w-[50%] rounded-[36px] xl:w-[46%] lg:min-h-[692px] h-[400px]" id="seller-home-steps-tostart-selling-hero-div">
            ...
            <aside className="mt-[30px] lg:mt-0 w-full lg:w-[50%] xl:w-[54%] relative">
                ...
                <div className="absolute top-[20px] left-[35%] lg:left-[43%] min-[1100px]:left-[42%] min-[1200px]:left-[41%] xl:left-[40%] min-[1400px]:left-[39%] min-[1450px]:left-[38%] min-[1500px]:left-[37%] 2xl:left-[35%]">
                    <p className="lg:text-xl font-medium">Register as a seller</p>
                    <p className="mt-2 text-xs lg:text-[14px] max-w-[78%]">Fill out our simple form to join our seller community.</p>
                </div>
                <div className="absolute top-[160px] left-[35%] lg:left-[43%] min-[1100px]:left-[42%] min-[1200px]:left-[41%] xl:left-[40%] min-[1400px]:left-[39%] min-[1450px]:left-[38%] min-[1500px]:left-[37%] 2xl:left-[35%]">
                    <p className="lg:text-xl font-medium">List your saree</p>
                    <p className="mt-2 text-xs lg:text-[14px] max-w-[78%]">Add detailed descriptions and high-quality photos.</p>
                </div>
                <div className="absolute top-[300px] left-[35%] lg:left-[43%] min-[1100px]:left-[42%] min-[1200px]:left-[41%] xl:left-[40%] min-[1400px]:left-[39%] min-[1450px]:left-[38%] min-[1500px]:left-[37%] 2xl:left-[35%]">
                    <p className="lg:text-xl font-medium">Manage your listing</p>
                    <p className="mt-2 text-xs lg:text-[14px] max-w-[78%]">Easily track your inventory and sales.</p>
                </div>
                <div className="absolute top-[440px] left-[35%] lg:left-[43%] min-[1100px]:left-[42%] min-[1200px]:left-[41%] xl:left-[40%] min-[1400px]:left-[39%] min-[1450px]:left-[38%] min-[1500px]:left-[37%] 2xl:left-[35%]">
                    <p className="lg:text-xl font-medium">Free shipping</p>
                    <p className="mt-2 text-xs lg:text-[14px] max-w-[78%]">Ship promptly and securely to buyers.</p>
                </div>
                <div className="absolute top-[585px] left-[35%] lg:left-[43%] min-[1100px]:left-[42%] min-[1200px]:left-[41%] xl:left-[40%] min-[1400px]:left-[39%] min-[1450px]:left-[38%] min-[1500px]:left-[37%] 2xl:left-[35%]">
                    <p className="lg:text-xl font-medium">Receive Payments</p>
                    <p className="mt-2 text-xs lg:text-[14px] max-w-[78%]">Get paid every Friday, securely.</p>
                </div>
            </aside>
        </section>
    </section>
