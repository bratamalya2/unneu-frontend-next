...
export default function SellerHomeStepsToStartSelling() {
    ...
    return <section className="absolute px-[5%] top-[700px] md:top-[900px] lg:top-[500px] 2xl:top-[750px] lg:mt-[85px] w-full">
        ...
        <section className="absolute lg:static flex flex-col md:flex-row flex-nowrap mt-[20px] md:mt-[48px] w-[90%] md:w-[90%] left-[5%] md:left-[10%]">
            ...
            <aside className="mt-[30px] lg:mt-0 w-full md:w-[40%] xl:w-[54%] relative">
                ...
                <div className="absolute top-[25px] left-[35%] md:left-[40%] lg:left-[55%] min-[1100px]:left-[52%] min-[1200px]:left-[51%] xl:left-[50%] min-[1400px]:left-[49%] min-[1450px]:left-[48%] min-[1500px]:left-[47%] 2xl:left-[45%]">
                ...
                <div className="absolute top-[165px] left-[35%] md:left-[40%] lg:left-[55%] min-[1100px]:left-[52%] min-[1200px]:left-[51%] xl:left-[50%] min-[1400px]:left-[49%] min-[1450px]:left-[48%] min-[1500px]:left-[47%] 2xl:left-[45%]">
                ...
                <div className="absolute top-[305px] left-[35%] md:left-[40%] lg:left-[55%] min-[1100px]:left-[52%] min-[1200px]:left-[51%] xl:left-[50%] min-[1400px]:left-[49%] min-[1450px]:left-[48%] min-[1500px]:left-[47%] 2xl:left-[45%]">
                ...
                <div className="absolute top-[445px] left-[35%] md:left-[40%] lg:left-[55%] min-[1100px]:left-[52%] min-[1200px]:left-[51%] xl:left-[50%] min-[1400px]:left-[49%] min-[1450px]:left-[48%] min-[1500px]:left-[47%] 2xl:left-[45%]">
                ...
                <div className="absolute top-[590px] left-[35%] md:left-[40%] lg:left-[55%] min-[1100px]:left-[52%] min-[1200px]:left-[51%] xl:left-[50%] min-[1400px]:left-[49%] min-[1450px]:left-[48%] min-[1500px]:left-[47%] 2xl:left-[45%]">
