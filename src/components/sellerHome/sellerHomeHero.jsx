...
export default function SellerHomeHero() {
    ...
    return <>
        ...
        <section className="lg:hidden absolute w-full h-[630px] mt-[40px]">
            <Image src={HeroBg} alt="bg-main" className="absolute w-full max-h-[350px]" />
            <Image src={PixelDots} alt="dots" className="absolute w-[62px] h-[46px] z-[-10] top-[40px] right-[5%]" />
            <Image src={Saree1} alt="saree" className="absolute w-[120px] h-[208px] top-[-30px] left-[2%] z-10" />
            <p className="text-[23px] font-medium w-[90%] absolute z-10 top-[350px] min-[390px]:top-[380px] min-[420px]:top-[410px] left-[5%]">Launch your reselling business with us in <span className="text-[#FEA355] font-semibold">2 mins.</span></p>
            <p className="text-sm w-[88%] absolute z-10 top-[430px] min-[390px]:top-[460px] min-[420px]:top-[490px] left-[5%]">
            ...
            <button className="absolute left-[5%] font-medium rounded-[16px] bg-[#FE9135] py-[12px] px-[22px] bottom-[50px] min-[390px]:bottom-[40px] min-[420px]:bottom-[10px] text-white" onClick={() => {
                router.push("/seller/register/1");
            }}>Start selling</button>
        </section>
    </>
