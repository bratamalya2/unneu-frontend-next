...
export default function SellerHomeHero() {
    ...
    return <>
        <section className="w-full lg:h-[525px] xl:h-[500px] 2xl:h-[700px] absolute">
            ...
            <p className="lg:text-[26px] xl:text-3xl 2xl:text-4xl lg:font-medium max-w-[34%] absolute z-10 left-[10%] lg:top-[106px] xl:top-[130px] 2xl:top-[205px]">Launch your reselling business with us in <span className="text-[#FEA355] font-semibold">2 mins.</span></p>
