...
export default function SellerHomeHero() {
    return <>
        <section className="w-full h-[545px] absolute">
            ...
            <Image src={HeroRight} alt="bg-right" className="absolute w-[267px] h-full top-0 right-0" />
            <Image src={HeroBg} alt="bg-main" className="absolute w-[50%] h-full top-0 right-[5%]" />
            <Image src={Saree1} alt="saree" className="absolute w-[180px] h-[208px] top-[39px] right-[40%]" />
