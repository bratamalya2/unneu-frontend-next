...
export default function SellerHomeHero() {
    ...
    return <>
        <section className="w-full lg:h-[525px] xl:h-[630px] 2xl:h-[700px] absolute">
            ...
            <Image src={Saree1} alt="saree" className="absolute w-[180px] xl:w-[235px] h-[208px] xl:h-[270px] top-[39px] xl:top-[50px] 2xl:top-[85px] lg:right-[36%] xl:right-[40%] 2xl:right-[36%]" />
            ...
            <p className="text-4xl font-medium max-w-[34%] absolute z-10 left-[10%] top-[106px] 2xl:top-[205px]">Launch your reselling business with us in <span className="text-[#FEA355] font-semibold">2 mins.</span></p>
            <p className="text-[18px] max-w-[32%] absolute z-10 left-[10%] top-[250px] 2xl:top-[330px]">Login or register as a seller at unneu.com. Become verified as a seller, list your product with us and streamline your business.</p>
