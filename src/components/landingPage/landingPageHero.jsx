...
export default function LandingPageHero() {
    return <>
        <section className="relative mt-[24px] md:h-[600px] lg:h-[650px] xl:h-[750px] 2xl:h-[829px] z-0 hidden md:block">
            ...
            <button className="absolute 2xl:left-[12%] xl:left-[10%] lg:left-[6%] md:left-[5%] top-[443px] xl:top-[400px] text-white text-[18px] px-[32px] py-[16px] rounded-[20px] bg-[#FE9135] hover:bg-[#FBC246]">Start Swapping</button>
        </section>
