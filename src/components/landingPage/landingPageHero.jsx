...
export default function LandingPageHero() {
    ...
    return <>
        <section className="relative mt-[24px] md:h-[600px] lg:h-[650px] xl:h-[750px] 2xl:h-[829px] z-0 hidden md:block">
            ...
            <p className="absolute 2xl:left-[7%] xl:left-[5.5%] lg:left-[6%] md:left-[5%] lg:top-[148px] xl:top-[160px] text-[#363636] md:font-semibold xl:font-bold md:text-[30px] lg:text-[36px] xl:text-[42px] md:max-w-[44%] lg:max-w-[44%] xl:max-w-[40%] 2xl:max-w-[36%]">Wardrobes are filled with sarees! Yet, nothing new to wear?</p>
            <p className="absolute 2xl:left-[7%] xl:left-[5.5%] lg:left-[6%] md:left-[5%] lg:top-[350px] xl:top-[400px] text-[#2B2A2A] font-medium md:text-lg xl:text-[22px] md:max-w-[45%] lg:max-w-[46%] xl:max-w-[42%] 2xl:max-w-[37.5%]">Welcome to &quot; India&apos;s First <span className="font-semibold text-[#FE9135]">saree aggregator</span> to buy and sell your pre-owned sarees at a negotiable fee&quot;. </p>
            <button className="absolute 2xl:left-[7%] xl:left-[5.5%] lg:left-[6%] md:left-[5%] lg:top-[483px] xl:top-[530px] text-white text-[18px] px-[32px] py-[16px] rounded-[20px] bg-[#FE9135] hover:bg-[#FBC246]" onClick={() => {
        ...
        <section className="relative mt-0 h-[760px] z-0 block md:hidden">
            ...
            <p className="absolute left-[5%] sm:left-[15%] bottom-[175px] font-medium text-[#2B2A2A] text-[14px] sm:max-w-[70%] mr-[5%] text-center">Welcome to &quot; India&apos;s First <span className="font-semibold text-[#FE9135]">saree aggregator</span> to buy and sell your pre-owned sarees at a negotiable fee&quot;. </p>
            <button className="absolute bottom-[95px] left-[30%] sm:left-[35%] text-white px-[16px] py-[12px] font-medium rounded-[9px] bg-[#FE9135] hover:bg-[#FBC246]" onClick={() => {
                router.push("/buyer/home");
            }}>Start Swapping</button>
        </section>
    </>
