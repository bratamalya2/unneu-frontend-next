...
export default function LandingPageHero() {
    return <>
        <section className="relative mt-[24px] md:h-[600px] lg:h-[650px] xl:h-[750px] 2xl:h-[829px] z-0 hidden md:block">
            ...
            <button className="absolute 2xl:left-[7%] xl:left-[5.5%] lg:left-[6%] md:left-[5%] top-[443px] xl:top-[420px] text-white text-[18px] px-[32px] py-[16px] rounded-[20px] bg-[#FE9135] hover:bg-[#FBC246]">Start Swapping</button>
        </section>
        <section className="relative mt-0 h-[760px] z-0 block md:hidden">
            ...
            <button className="absolute bottom-[95px] left-[30%] sm:left-[35%] text-white px-[16px] py-[12px] font-medium rounded-[9px] bg-[#FE9135] hover:bg-[#FBC246]">Start Swapping</button>
        </section>
    </>
}