...
export default function LandingPageSeller() {
    return <section className="relative w-full flex flex-col items-center" id="landing-page-seller">
        ...
        <Image src={SampleSeller} alt="sample seller" className="w-[95%] lg:w-[90%] max-h-[400px] sm:max-h-[645px] lg:max-h-[950px] xl:max-h-[1020px] 2xl:w-[85%] inline-block mx-auto rounded-[32px] absolute z-20 top-[-15px] sm:top-[5px]" />
    </section>
}