...
export default function ItemsSections({ sellerDetails }) {
    ...
    return <section className="relative z-10 top-[-70px] px-[5%] lg:mb-[85px] flex flex-col">
        ...
        <div className="mt-[24px] lg:mt-[50px] w-full flex flex-row flex-nowrap items-center justify-between">
            ...
            <div className="w-[55%] lg:w-[25%] xl:w-[20%] 2xl:w-[15%] flex flex-row flex-nowrap items-center justify-between">
        ...
        {
            sellerDetails.noOfItemsListed !== "0" && (
                <div className="pr-[1%] w-full max-h-[900px] mt-[32px] flex flex-row flex-wrap gap-x-4 lg:gap-x-[12px] xl:gap-x-[25px] min-[1400px]:gap-x-[30px] 2xl:gap-x-[15px] gap-y-[50px] lg:gap-y-10 overflow-y-auto">
                    {
                        sortedItemDetails.map((x, i) => <Item itemDetail={x} sellerId={sellerDetails.sellerId} setIsItemDeleted={setIsItemDeleted} key={i} />)
                    }
                </div>
            )
        }
