...
export default function LandingPageNavSection() {
    return <aside className="relative bg-white w-[90%] xl:w-[80%] h-[432px] rounded-[36px] mx-auto z-50 top-[-45px] flex justify-around items-center" style={{
        boxShadow: "0px 11px 40px 4px rgba(81, 69, 55, 0.05)"
    }}>
        <section className="flex flex-col items-center lg:max-w-[23%]">
            ...
            <button className="bg-[#FBC246] py-[12px] px-[47px] rounded-[12px] mt-[32px] text-black font-medium text-[18px] hover:bg-[#FE9135]">Sell now</button>
        </section>
        <section className="flex flex-col items-center lg:max-w-[23%]">
            ...
            <button className="bg-[#FBC246] py-[12px] px-[47px] rounded-[12px] mt-[32px] text-black font-medium text-[18px] hover:bg-[#FE9135]">Buy now</button>
        </section>
        <section className="flex flex-col items-center lg:max-w-[23%]">
            ...
            <button className="bg-[#FBC246] py-[12px] px-[47px] rounded-[12px] mt-[32px] text-black font-medium text-[18px] hover:bg-[#FE9135]">Rent now</button>
        </section>
    </aside>
}