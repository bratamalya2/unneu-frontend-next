...
export default function LandingPageHero() {
    return <>
        ...
        <section className="relative mt-[24px] h-[760px] z-0 block sm:hidden">
            ...
            <button className="absolute left-[5%] bottom-[90px] left-[30%] text-white px-[16px] py-[12px] font-medium rounded-[9px] bg-[#FE9135] hover:bg-[#FBC246]">Start Swapping</button>
        </section>
    </>
}