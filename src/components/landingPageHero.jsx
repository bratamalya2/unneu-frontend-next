...
export default function LandingPageHero() {
    return <section className="relative mt-[24px] lg:h-[650px] xl:h-[750px] 2xl:h-[829px] z-0">
        ...
        <Image src={HeroForeground} alt="foreground" className="absolute lg:w-[29%] xl:w-[36%] 2xl:w-[34%] lg:h-[550px] xl:h-[720px] 2xl:h-[730px] z-10 lg:right-[22%] xl:right-[17%] 2xl:right-[24%] lg:top-[60px] top-20" />
